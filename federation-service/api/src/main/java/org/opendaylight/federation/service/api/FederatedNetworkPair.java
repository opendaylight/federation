...
public class FederatedNetworkPair {
    ...
    public FederatedNetworkPair(String localNetworkId, String remoteNetworkId, Uuid localSubnetId,
            Uuid remoteSubnetId, Uuid localTenantId, Uuid remoteTenantId) {
        this.consumerNetworkId = localNetworkId;
        this.producerNetworkId = remoteNetworkId;
    ...
    public FederatedNetworkPair(Uuid localNetworkId, Uuid remoteNetworkId, Uuid localSubnetId,
            Uuid remoteSubnetId, Uuid localTenantId, Uuid remoteTenantId) {
    ...
    public String toString() {
        return "FederatedNetworkPair " + "[consumerNetworkId=" + consumerNetworkId
                + ", producerNetworkId=" + producerNetworkId + "]"
                + "[consumerSubnetId=" + consumerSubnetId + ", producerSubnetId="
                + producerSubnetId + "]" + "[consumerTenantId=" + consumerTenantId
